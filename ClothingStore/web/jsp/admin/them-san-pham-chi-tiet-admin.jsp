                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="all-form-element-inner">
                                                    <!-- form để insert -->
                                                    <spring:form action="them-san-pham-chi-tiet.htm" modelAttribute="spct">
                                                        <!--Mã sản phẩm-->
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12" style="width: 50%;">
                                                                    <spring:input path="maSPCT" class="form-control" />
                                                                </div>
                                                            </div>
                                                        </div>                                                        
                                                        <!--Màu-->
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12" style="width: 50%;">
                                                                    <spring:input type="number" path="soLuong" min="0" value="0" class="form-control" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12" style="width: 50%;">
                                                                    <spring:input type="number" path="giaGoc" min="0" step="1000" value="0" class="form-control" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12" style="width: 10%;">
                                                                    <spring:input type="number" path="giaKM" min="0" step="5" value="0" class="form-control" />
                                                                </div>
                                                            </div>
                                                        </div>                                                        
                                                        <div class="form-group-inner">
