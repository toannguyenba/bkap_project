                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="all-form-element-inner">
                                                    <!-- form để insert -->
                                                    <spring:form action="them-kich-thuoc.htm" modelAttribute="kt">
                                                        <!--Mã kích thước-->
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12" style="width: 50%;">
                                                                    <spring:input path="maKichThuoc" class="form-control" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--Tên kích thước-->
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12" style="width: 50%;">
                                                                    <spring:input path="tenKichThuoc" class="form-control" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--Ghi chú-->
                                ...
                                <table>
                                    ...
                                    <c:forEach items="${listKt}" var="kt">
                                        <tr>
                                            ...
                                            <td>${kt.trangThai}</td>
                                            <td>                                                
                                                <a href="init-cap-nhat-kich-thuoc.htm?id=${kt.maKichThuoc}"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                <a href="xoa-kich-thuoc.htm?id=${kt.maKichThuoc}"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                            </td>
                                        </tr>
                                    </c:forEach>                                    
                                </table>
