                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="all-form-element-inner">
                                                    <!-- form để insert -->
                                                    <spring:form action="cap-nhat-san-pham.htm" modelAttribute="sp" method="post" enctype="multipart/form-data">
                                                        <!--Mã danh mục-->
                                                                ...
                                                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12" style="width: 50%;">
                                                                    <div class="form-select-list">
                                                                        <spring:select path="maDM" class="form-control custom-select-value" name="account">
                                                                            <option value="${sp.maDM.maDM}" selected="true" hidden="true">${sp.maDM.tenDM}</option>
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12" style="width: 50%;">
                                                                    <spring:input path="maSP" value="${sp.maSP}" class="form-control" readonly="true" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--Tên sản phẩm-->
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12" style="width: 50%;">
                                                                    <spring:input path="tenSP" value="${sp.tenSP}" class="form-control" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--Mã NSX-->
                                                                ...
                                                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12" style="width: 50%;">
                                                                    <div class="form-select-list">
                                                                        <spring:select path="maNSX" class="form-control custom-select-value" name="account">                                                                          
                                                                            <option value="${sp.maNSX.maNSX}" selected="true" hidden="true">${sp.maNSX.tenNSX}</option>
